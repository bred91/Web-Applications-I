...
document.getElementById("filter-all").addEventListener("click", 
    () => filterFilms('filter-all', 'All Films', filmLibrary.filterAll));

document.getElementById("filter-favorites").addEventListener("click",
    () => filterFilms('filter-favorites', 'Favorite Films', filmLibrary.filterByFavorite));

document.getElementById("filter-best").addEventListener("click",
    () => filterFilms('filter-best', 'Best Rated Films', filmLibrary.filterByBestRated));

document.getElementById("filter-seen-last-month").addEventListener("click",
    () => filterFilms('filter-seen-last-month', 'Films Seen Last Month', filmLibrary.filterBySeenLastMonth));

document.getElementById("filter-unseen").addEventListener("click",
    () => filterFilms('filter-unseen', 'Unseen Films', filmLibrary.filterByUnseen));